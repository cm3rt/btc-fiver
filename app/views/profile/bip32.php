<?php $title = 'BIP32 configuration | '.$_SERVER['HTTP_HOST'] ?>
...
<div class="large-12 columns">
    ...
    <?php else: ?>
        <div data-alert class="alert-box secondary">
            ...
            <br/><br/>
            <strong>You can use <a href="http://bip32.Joseph Alai.com/" target="_blank">bip32.Joseph Alai.com</a> to generate your extended public key:</strong>
            <ol>
